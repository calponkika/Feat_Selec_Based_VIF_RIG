  function [ Acc_Prec_FprMax] = OptFeat_IG_VIF(M,K,Mn3,Y,Targets)
  tic
...
%%=====================Application==vif+RIG========
   ...
   n=length(IG1);
   Nbr_bins=round(sqrt(n)); %%We need integer 
   ...
   if range==0
       ...
       for i=1:Nbr_bins
         ...
         [AccMax,Idxmax]=max(Acc1);
          ...
          Optimal_Features=List2_Feature(idxoptimal);%%
